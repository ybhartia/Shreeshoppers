...
var MonitoringLog = /** @class */ (function (_super) {
    ...
    function MonitoringLog(msg, options, extra) {
...
var Monitoring = /** @class */ (function () {
    function Monitoring(app) {
        ...
        tracekit_1.subscribe(function (errorReport) {
            ...
            console.log('HANDLING CAPTURED');
            console.log('ORIGINAL', errorReport);
    ...
    Monitoring.prototype.handleNewError = function (err, extra) {
        ...
        console.log('HANDLING NEW ERROR');
        console.log('ORIGINAL', err);
        console.log('COMPUTED', stack);
        console.log();
        console.trace();
    ...
    Monitoring.prototype.log = function (msg, options, extra) {
        var log = new MonitoringLog(msg, options, extra);
